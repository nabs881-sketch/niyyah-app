...
function renderDefiCard() {
  ...
  if (!defi) {
    document.getElementById('defiCardIcon').innerHTML = '<img src="https://nabs881-sketch.github.io/niyyah-app/imagescroissant.png" width="50" height="50" alt="Croissant" style="object-fit:contain;mix-blend-mode:screen;">';
...
function updateFajrChallenge() {
  ...
  if (fajrStreak >= 30) {
    ...
    card.innerHTML = '<div style="background:#1a1a1a;border:1px solid rgba(200,168,75,0.3);border-radius:14px;padding:14px 18px;text-align:center;">'
      ...
      + '<div><img src="https://nabs881-sketch.github.io/niyyah-app/imagessoleil.png" width="60" height="60" alt="Soleil" style="object-fit:contain;mix-blend-mode:screen;"></div>'
      + '<div>'
