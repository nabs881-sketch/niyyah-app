...
const ONBOARD_SLIDES = [
  ...
  () => '<div class="onboard-anim">'
    ...
    + '<div class="ob-notif-icon"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="var(--gold)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2c-2 6-8 7-8 13a8 8 0 0 0 16 0c0-6-6-7-8-13z"/><path d="M12 22v-4"/></svg></div>'
    ...
    + '<div class="ob-notif-icon"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="var(--gold)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2c0 4 4 6 4 10a4 4 0 0 1-8 0c0-4 4-6 4-10z"/><path d="M12 18c-1 0-2-1-2-2 0-2 2-3 2-5 0 2 2 3 2 5 0 1-1 2-2 2z"/></svg></div>'
