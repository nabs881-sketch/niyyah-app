...
function renderDefiCard() {
  ...
  if (!defi) {
    document.getElementById('defiCardIcon').innerHTML = '<img src="https://nabs881-sketch.github.io/niyyah-app/imagescroissant.png" width="80" height="80" alt="Croissant" style="object-fit:contain;filter:invert(1) brightness(1.5) sepia(1) hue-rotate(5deg) saturate(3);mix-blend-mode:screen;background:none !important;box-shadow:none !important;border:none !important;">';
