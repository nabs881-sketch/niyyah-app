...
function getGraineSVG(count) {
  ...
  return '<svg width="140" height="140" viewBox="0 0 140 140" style="animation:grainFloat 3s ease-in-out infinite;"><line x1="40" y1="103" x2="100" y2="103" stroke="#8B6914" stroke-width="2"/><ellipse cx="70" cy="95" rx="12" ry="8" fill="#C8A84A"/></svg>';
}
