...
const ONBOARD_SLIDES = [
  ...
  () => {
    ...
    return '<div class="onboard-anim">'
      ...
      + '<img src="images/niyyah-glass.webp" alt="" style="width:100%;max-width:180px;height:auto;display:block;margin:0 auto 10px;">'
      + '<div style="font-size:16px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#C8A84A;margin-bottom:4px;">'+t('ob_niyyah_title')+'</div>'
      + '<div style="font-size:13px;color:rgba(200,168,75,0.6);margin-bottom:8px;">'+t('ob_avant_acte')+'</div>'
      + '<div style="font-size:14px;color:rgba(200,168,75,0.7);line-height:1.6;margin-bottom:10px;">'+t('ob_niyyah_desc')+'</div>'
      + '<div class="ob-geste-txt" id="obTypeNiyyah" style="color:rgba(200,168,75,0.8);font-size:14px;">&nbsp;</div>'
      + '</div>'
      // Card Regarde (droite)
      ...
      + '<img src="images/regarde-hand.webp" alt="" style="width:100%;max-width:180px;height:auto;display:block;margin:0 auto 10px;">'
      + '<div style="font-size:16px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#A0A4AC;margin-bottom:4px;">'+t('ob_regarde_title')+'</div>'
      + '<div style="font-size:13px;color:rgba(160,164,172,0.6);margin-bottom:8px;">'+t('ob_apres_acte')+'</div>'
      + '<div style="font-size:14px;color:rgba(160,164,172,0.7);line-height:1.6;margin-bottom:10px;">'+t('ob_regarde_desc')+'</div>'
      + '<div class="ob-geste-txt" id="obTypeRegarde" style="color:rgba(160,164,172,0.8);font-size:14px;">&nbsp;</div>'
      + '</div>'
      + '</div>'
