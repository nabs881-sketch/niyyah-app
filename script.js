...
function renderProgression() {
  ...
  const heroSectionP = '<div style="margin:0 16px 24px;"><div style="font-family:\'Cinzel\',serif;font-size:11px;letter-spacing:2.5px;color:rgba(255,255,255,0.3);text-transform:uppercase;margin-bottom:12px;">PROGRESSION</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">'+lvlGridP+'</div></div>';
