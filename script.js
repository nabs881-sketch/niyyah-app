...
function scannerShowResult(data) {
  ...
  if (data.niyyahDirect) {
    ...
    // Injecter bouton partage dynamiquement
    var actionsEl = document.querySelector('.scanner-actions');
    if (actionsEl && !document.getElementById('scanner-btn-share')) {
      var shareBtn = document.createElement('button');
      shareBtn.className = 'scanner-btn-share';
      shareBtn.id = 'scanner-btn-share';
      ...
      shareBtn.addEventListener('click', function() { scannerShareNiyyah(); });
      var confirmBtn = document.getElementById('scanner-btn-confirm');
      if (confirmBtn) confirmBtn.after(shareBtn);
    }
