...
const ONBOARD_SLIDES = [
  ...
  () => {
    ...
    return '<div class="onboard-anim">'
      ...
      + '<div style="width:90px;height:90px;border:2px dashed rgba(200,168,75,0.25);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 10px;"><img src="images/niyyah-glass.webp" alt="" style="width:60px;height:auto;display:block;"></div>'
      ...
      + '<div style="width:90px;height:90px;border:2px dashed rgba(160,164,172,0.25);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 10px;"><img src="images/regarde-hand.webp" alt="" style="width:60px;height:auto;display:block;"></div>'
