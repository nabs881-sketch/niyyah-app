...
const ONBOARD_SLIDES = [
  ...
  () => {
    ...
    return '<div class="onboard-anim">'
      ...
      + '<div style="position:relative;width:90px;height:90px;border:2px dashed rgba(200,168,75,0.3);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 10px;box-shadow:0 0 20px rgba(200,168,75,0.1);"><img src="images/niyyah-glass.webp" alt="" style="width:60px;height:auto;display:block;filter:drop-shadow(0 0 8px rgba(200,168,75,0.4));"><span style="position:absolute;top:6px;right:8px;color:#C8A84A;font-size:10px;opacity:0.7;">\u2726</span><span style="position:absolute;bottom:8px;left:10px;color:#C8A84A;font-size:8px;opacity:0.5;">\u2726</span><span style="position:absolute;top:40px;right:4px;color:#C8A84A;font-size:6px;opacity:0.4;">\u2726</span></div>'
      ...
      + '<div style="width:90px;height:90px;border:2px dashed rgba(160,164,172,0.25);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 10px;"><img src="images/niyyah-glass.webp" alt="" style="width:60px;height:auto;display:block;filter:grayscale(1) brightness(1.3) opacity(0.8);"></div>'
