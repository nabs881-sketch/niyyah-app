...
const ONBOARD_SLIDES = [
  () => `
    <div class="onboard-anim"><div style="margin:0 auto 20px;animation:onboardFloat 3s ease-in-out infinite;"><img src="https://nabs881-sketch.github.io/niyyah-app/imageslogo.png" alt="Niyyah" style="width:150px;height:auto;display:block;margin:0 auto;"></div><div class="onboard-logo">Niyyah Daily</div><div class="onboard-tagline">نِيَّة · Pose ton intention</div><div class="onboard-title">Ta pratique spirituelle,<br>chaque jour</div><div class="onboard-sub">Niyyah t\'accompagne dans ton chemin vers Allah — à ton rythme, sans jugement.</div><button class="onboard-btn" onclick="onboardNext()">Commencer →</button><button class="onboard-skip" onclick="onboardFinish()">Passer</button></div>`,
  () => `
